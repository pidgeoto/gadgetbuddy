import ProductByBrand from "@/components/pages/products/ProductByBrand";
import React from "react";
export async function generateMetadata() {
  return {
    title: "Product by brand - 32mobiles.com",
    ...
    alternates: {
      canonical: "https://www.32mobiles.com/brand",
      languages: {
        "en-US": "/en-US",
        "de-DE": "/de-DE",
      },
...
const BrandIdPage = ({ params: { slug } }) => {
  return (
    <div>
      <ProductByBrand brandId={slug} />
    </div>
  );
};
