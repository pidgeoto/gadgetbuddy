...
const HeadphoneComparisonPage = ({ modelIdForCard, index, onRemove }) => {
  ...
  return (
    <table>
      ...
      {Object.keys(item).map((key) => {
        if (key.includes("headphone_")) {
          const sanitizedKey = key.replace("headphone_", "");
          return (
            <tr key={key}>
              {index === 0 ? (
                <th>
...
export default HeadphoneComparisonPage;
