...
const LatestArticles = () => {
  ...
  const latestArticles = articles.filter((item) => item.tags.includes(2));

  const filteredArticles = latestArticles.filter((latestArticle) => {
    const query = searchQuery.toLowerCase();
    const title = latestArticle.title.toLowerCase();
