...
const UpcomingGadgets = () => {
  ...
  const upcomingArticles = articles.filter((item) => item.tags.includes(1));

  const filteredArticles = upcomingArticles.filter((upcomingArticle) => {
    const query = searchQuery.toLowerCase();
    const title = upcomingArticle.title.toLowerCase();
...
export default UpcomingGadgets;
